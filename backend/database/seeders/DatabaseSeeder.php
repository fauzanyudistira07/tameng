    ...
    public function run(): void
    {
        ...
        $profiles = [
            ...
            [
                'key' => 'web_safe_scan',
                'name' => 'Web Safe Scan',
                'description' => 'Passive/spider web assessment, TLS/SSL cipher audit, and safe Nuclei template allowlist.',
                'allowed_target_types' => json_encode(['web']),
                'engine_keys' => json_encode(['zap', 'nuclei', 'testssl']),
            ...
            [
                'key' => 'api_safe_scan',
                'name' => 'API Safe Scan',
                'description' => 'OpenAPI/API scan with strict scope, TLS audit, and egress policy.',
            ...
            [
                ...
                'description' => 'Repository, dependency, TLS, web/API safe assessment using all MVP engines.',
                'allowed_target_types' => json_encode(['repository', 'web', 'api']),
                'engine_keys' => json_encode(['semgrep', 'gitleaks', 'trivy', 'osv', 'zap', 'nuclei', 'testssl']),
