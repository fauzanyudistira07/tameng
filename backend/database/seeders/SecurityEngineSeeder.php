...
class SecurityEngineSeeder extends Seeder
{
    ...
    {
        $readyEngines = ['semgrep', 'gitleaks', 'trivy', 'osv', 'zap', 'nuclei', 'hadolint', 'checkov', 'syft', 'grype', 'mobsf', 'testssl'];
        ...
        $engines = [
            ...
            [
                ...
                'version' => '1.0.0',
                'adapter_version' => '1.0.0',
                'container_image' => 'opensecurity/mobsfscan:latest',
                'resource_class' => 'MEDIUM',
                'supported_targets' => ['mobile', 'mobile_app', 'repository'],
                'default_timeout' => 600,
                'cpu_limit' => 2.0,
                'memory_limit_mb' => 2048,
