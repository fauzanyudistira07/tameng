  ...
  >
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" style="max-width: 620px;" role="document">
      <div class="modal-content shadow-lg border-0">
        ...
        <!-- Footer -->
        <div class="modal-footer border-top py-2 px-4 bg-body-tertiary d-flex flex-column-reverse flex-sm-row align-items-stretch align-items-sm-center justify-content-sm-between gap-2">
          <template v-if="!isEditing">
            <button
              type="button"
              class="btn btn-primary d-inline-flex align-items-center justify-content-center gap-1 w-100 w-sm-auto"
              @click="startEditing"
            >
          ...
          <template v-else>
            ...
            <button
              type="button"
              class="btn btn-primary d-inline-flex align-items-center justify-content-center gap-1 w-100 w-sm-auto py-2"
              :disabled="isSaving"
