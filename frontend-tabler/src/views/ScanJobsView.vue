    ...
    <transition name="toast-slide">
      ...
      <div class="card">
        ...
        <div class="d-md-none list-group list-group-flush">
          <div v-if="filteredJobs.length === 0" class="p-4 text-center text-secondary">
            Tidak ada pekerjaan scan ditemukan.
          </div>
          <div
      ...
      <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer d-flex flex-column-reverse flex-sm-row align-items-stretch align-items-sm-center justify-content-sm-between gap-2">
            <button type="button" class="btn btn-secondary w-100 w-sm-auto justify-content-center" @click="closeCreateModal">
              Batal
            </button>
            <button
              type="button"
